...
List<TravelDestination> destinations(BuildContext context) => [
      TravelDestination(
        assetName: 'images/saltbagel.jpg',
        ...
        child: Column(
          children: [
            SectionTitle(
                ...
                //GalleryLocalizations.of(context).cardsDemoTappable),
            SizedBox(
              height: height,
              child: Card(
        ...
        child: Column(
          children: [
            SectionTitle(
                ...
                //GalleryLocalizations.of(context).cardsDemoSelectable),
            SizedBox(
              height: height,
              child: Card(
                // This ensures that the Card's children (including the ink splash) are clipped correctly.
...
class TravelDestinationContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final descriptionStyle = theme.textTheme.subtitle;
          ...
          ButtonBar(
            ...
            children: [
              FlatButton(
                ...
                onPressed: () {
                   Navigator.pushNamed(context, '/first.dart');
                  //print('pressed');
                },
              ),
              FlatButton(
                ...
                textColor: Colors.amber.shade500,
                onPressed: () {
                  Navigator.pushNamed(context, '/fourth.dart');
                  print('pressed');
                },
              ),
            ],
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text( "title test"),
          //GalleryLocalizations.of(context).demoCardTitle),
      ),
      body: Scrollbar(
        child: ListView(
